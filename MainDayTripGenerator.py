...
parameters_for_transportation = [['Rocket Ship', 'Submarine', 'Teleporter', 'Giant Hamster Wheel', 'Glider'], "If you really feel like walking enter 'Skip'. Otherwise type anything else followed by 'Enter' to start again: ", "After checking all available transport it looks like our most compatable transportation for you is a", 'foot']
parameters_for_restaurant = [["Weenie Hut Jr's","The Chow Hall", "the McDonalds Top Secret Platinum Club", "Bob's Burgers", "Costco"], "If you really don't feel hungry enter 'Skip'. Otherwise type anything else followed by 'Enter' to start again: ", "After a quick search through all available restaurants with seating available it looks like our most compatable restaurant for you is", 'home']
...
while confirmed != True:
    if confirmed == 'DESTINATION':
        ...
        confirmed = final_confirmation()
#Final line of code that runs once the user confirms up in the 'final_confirmation' 
if confirmed == True:
